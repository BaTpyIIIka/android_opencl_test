...
public class CLUtils {
    private final static String TAG = "CLUtils";
...
//        }
        ...
        try {
            System.load("/system/vendor/lib64/libPVROCL.so");
//            System.load("/vendor/lib64/libOpenCL.so");
//            System.loadLibrary("OpenCL");
            System.loadLibrary("cl_test");
    ...
    static public native int initCL();
    ...
    static public native void begin();
    static public native float end();
    ...
    static public ByteBuffer getProgramBuffer(Context ctx, String file) {
        ...
        try {
            stream = ctx.getResources().openRawResource(R.raw.gauss_5x5);
