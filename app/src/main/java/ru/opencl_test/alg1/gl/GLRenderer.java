...
import ru.opencl_test.alg1.kernelgen.KernelGenerator;
import ru.opencl_test.alg1.kernelgen.KernelLangGLSL;
...
//                2f,   7f,   12f,    7f,   2f
//        };
//        kernelGen.setKernel("gauss5x5", 5, 5, kernelVals5x5);
//        String[] codeStrings = kernelGen.getKernelCodeStrings(KernelGenerator.KernelLang.GLSL);
//        System.out.println(Arrays.asList(codeStrings));
//    }
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig conf) {
        ...
        if (useTestCases) {
            ...
            bitmaps.add(BitmapFactory.decodeResource(ctx.getResources(), R.mipmap.p1024));
    ...
    private void setupTestCases() {
        ...
        imgSet[0] = R.mipmap.p128;
        bitmapNames.add("128x128");
        imgSet[1] = R.mipmap.p256;
        bitmapNames.add("256x256");
        imgSet[2] = R.mipmap.p512;
        bitmapNames.add("512x512");
        imgSet[3] = R.mipmap.p1024;
        bitmapNames.add("1024x1024");
        imgSet[3] = R.mipmap.p2048;
