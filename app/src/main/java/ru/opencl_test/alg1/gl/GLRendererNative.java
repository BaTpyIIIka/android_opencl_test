...
public class GLRendererNative implements GLSurfaceView.Renderer {
    private static final String TAG = "OGLES20RendererNative";
    ...
    private GLRendererSimple.Listener listener;
    private GLSurfaceView view;

    public GLRendererNative(Context ctx) {
        this.ctx = ctx;

        Matrix.setIdentityM(identMat, 0);
    }

    public void test(GLSurfaceView view, Bitmap bitmap, int tests, GLRendererSimple.Listener listener) {
